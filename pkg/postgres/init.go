...
func Connect(DBConnection Config) (*gorm.DB, error) {
	...
	SetPrintLog(DBConnection.DBLogEnable, DBConnection.DBLogLevel, DBConnection.DBLogThreshold*time.Millisecond)
